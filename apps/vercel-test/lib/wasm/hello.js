...
var _get_json_response = Module['_get_json_response'] = makeInvalidEarlyAccess('_get_json_response');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['get_json_response'] != 'undefined', 'missing Wasm export: get_json_response');
  ...
  _get_json_response = Module['_get_json_response'] = createExportWrapper('get_json_response', 0);
